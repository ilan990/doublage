 ...
 */
final class Version20230225132441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comedien (id_comedien INT AUTO_INCREMENT NOT NULL, thumbnail_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, telephone INT NOT NULL, email VARCHAR(255) NOT NULL, age INT DEFAULT NULL, sexe VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_E2C2E3C2FDFF2E92 (thumbnail_id), PRIMARY KEY(id_comedien)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE comedien ADD CONSTRAINT FK_E2C2E3C2FDFF2E92 FOREIGN KEY (thumbnail_id) REFERENCES thumbnail (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comedien DROP FOREIGN KEY FK_E2C2E3C2FDFF2E92');
