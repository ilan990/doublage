 ...
 */
final class Version20230307191144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contrat_comedien (id_contrat_comedien INT AUTO_INCREMENT NOT NULL, id_comedien INT DEFAULT NULL, id_da INT DEFAULT NULL, id_role INT DEFAULT NULL, creation_contrat DATE DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, production INT DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, role_comedien VARCHAR(255) DEFAULT NULL, INDEX IDX_5B0DF998B2190F57 (id_comedien), INDEX IDX_5B0DF998BA801495 (id_da), UNIQUE INDEX UNIQ_5B0DF998DC499668 (id_role), PRIMARY KEY(id_contrat_comedien)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
