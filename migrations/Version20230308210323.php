 ...
 */
final class Version20230308210323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contrat_comedien (id_contrat_comedien INT AUTO_INCREMENT NOT NULL, id_comedien INT DEFAULT NULL, id_da INT DEFAULT NULL, id_role INT DEFAULT NULL, creation_contrat DATE DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, INDEX IDX_5B0DF998B2190F57 (id_comedien), INDEX IDX_5B0DF998BA801495 (id_da), UNIQUE INDEX UNIQ_5B0DF998DC499668 (id_role), PRIMARY KEY(id_contrat_comedien)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contrat_da (id_contrat_da INT AUTO_INCREMENT NOT NULL, id_da INT DEFAULT NULL, id_production INT DEFAULT NULL, creation_contrat DATE DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, nbre_role INT DEFAULT NULL, montant INT DEFAULT NULL, img_film VARCHAR(255) DEFAULT NULL, INDEX IDX_DDE78CDDBA801495 (id_da), INDEX IDX_DDE78CDD76673137 (id_production), PRIMARY KEY(id_contrat_da)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE production (id_production INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id_production)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE role (id_role INT AUTO_INCREMENT NOT NULL, id_contrat_da INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, sexe VARCHAR(255) NOT NULL, INDEX IDX_57698A6A786D0C0A (id_contrat_da), PRIMARY KEY(id_role)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE contrat_comedien ADD CONSTRAINT FK_5B0DF998DC499668 FOREIGN KEY (id_role) REFERENCES role (id_role)');
        ...
        $this->addSql('ALTER TABLE role ADD CONSTRAINT FK_57698A6A786D0C0A FOREIGN KEY (id_contrat_da) REFERENCES contrat_da (id_contrat_da)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat_comedien DROP FOREIGN KEY FK_5B0DF998DC499668');
        ...
        $this->addSql('ALTER TABLE role DROP FOREIGN KEY FK_57698A6A786D0C0A');
